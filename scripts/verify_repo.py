...
def verify_companion_tooling(errors: list[str]) -> None:
    ...
    elif scripts.get("ci") != "pnpm build && pnpm typecheck && pnpm test && pnpm consumer-smoke && pnpm examples-smoke && pnpm readme-examples:check && pnpm api-docs:check && pnpm api-review:check && pnpm browser-runtime-imports:check && pnpm public-imports:check && pnpm pack-smoke":
