...
popup HTML, native-host binding, selected route metadata, origin-permission
metadata in the packaged background script, file hashes, byte counts, exact
output directory contents, and bundled JavaScript browser-runtime hygiene, and
writes no files.
